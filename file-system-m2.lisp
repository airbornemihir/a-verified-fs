...
(defthm
  ...
  (("goal"
    :use
    ((:instance m1-stricter-file-alist-p
                (fs (m1-file->contents (cdr (car fs)))))
     (:instance
      m1-stricter-file-alist-p-necc
      (pathname
...
(defthm
  ...
  (implies
   (and (m1-stricter-file-alist-p fs)
        (consp fs))
   (not (useless-dir-ent-p (m1-file->dir-ent (cdr (car fs))))))
  :hints
