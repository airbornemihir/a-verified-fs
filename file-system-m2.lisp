...
(update-stobj-scalar-correctness 16 update-bpb_rsvdseccnt fat32-in-memory
                                 fat32-in-memoryp
                                 update-bpb_rsvdseccnt-correctness-1)

(update-stobj-scalar-correctness 8 update-bpb_secperclus fat32-in-memory
                                 fat32-in-memoryp
                                 update-bpb_secperclus-correctness-1)

(update-stobj-scalar-correctness 16 update-bpb_bytspersec fat32-in-memory
                                 fat32-in-memoryp
                                 update-bpb_bytspersec-correctness-1)

(update-stobj-scalar-correctness 8 update-bpb_numfats fat32-in-memory
                                 fat32-in-memoryp
