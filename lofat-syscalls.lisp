...
(defthm lofat-unlink-refinement-lemma-9
  (implies (equal (mv-nth 1 (lofat-to-hifat fat32-in-memory))
                  0)
           (equal (mv-nth '1
                          (root-dir-ent-list fat32-in-memory))
                  '0))
  :hints (("goal" :in-theory (enable lofat-to-hifat root-dir-ent-list
                                     dir-ent-clusterchain-contents
                                     pseudo-root-dir-ent))))

(encapsulate
  () ;; start lemmas for lofat-unlink-refinement
     ...
     (implies
      ...
      (equal
       (mv-nth 1
               (dir-ent-clusterchain fat32-in-memory
                                     (pseudo-root-dir-ent fat32-in-memory)))
       (mv-nth 1 (root-dir-ent-list fat32-in-memory))))
     :hints (("goal" :in-theory (enable root-dir-ent-list
                                        pseudo-root-dir-ent)))))
  ...
  (local
   (defthm
     ...
     (("goal"
       :in-theory
       (e/d
        (dir-ent-clusterchain-contents pseudo-root-dir-ent root-dir-ent-list)
       ...
       ((:instance
        ...
        (:instance
         ...
         (entry-limit (max-entry-count fat32-in-memory))
         (dir-ent (pseudo-root-dir-ent fat32-in-memory))))))))
  ...
  (local
   (defthm
     ...
     :hints
     (("goal"
       :in-theory (e/d (pseudo-root-dir-ent)
                       ((:rewrite get-clusterchain-contents-correctness-2)))
       :use
       (:instance
        (:rewrite get-clusterchain-contents-correctness-2)
      ...
      (not-intersectp-list
       ...
       (mv-nth
        ...
        (lofat-to-hifat-helper
         ...
         (max-entry-count fat32-in-memory)))))
     :hints
     (("goal" :in-theory (e/d (pseudo-root-dir-ent dir-ent-clusterchain))))))
  ...
  (local
   (defthm
     ...
     :hints
     (("goal"
       :in-theory (e/d (dir-ent-clusterchain-contents pseudo-root-dir-ent))))))
  ...
  (defthm
    ...
    (implies
     (and
      ...
      (equal (mv-nth 1 (lofat-unlink fat32-in-memory pathname)) 0)
      (m1-regular-file-p
       (mv-nth
        0
        (hifat-find-file
      ...
      (equal
       (mv-nth 1
               (hifat-remove-file (mv-nth 0 (lofat-to-hifat fat32-in-memory))
                                  pathname))
       0)
      (no-duplicatesp-equal
       (mv-nth
        0
        (dir-ent-clusterchain (mv-nth 0
                                      (lofat-unlink fat32-in-memory pathname))
                              (pseudo-root-dir-ent fat32-in-memory)))))
     (equal
      (mv-nth 0
    ...
    (("goal"
      ...
      :do-not-induct t
      :use (:instance (:rewrite lofat-remove-file-correctness-1)
                      (entry-limit (max-entry-count fat32-in-memory))
                      (pathname pathname)
