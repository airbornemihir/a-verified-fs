...
\begin{frame}{Minimal set of operations?}
  ...
  \item Of these, \texttt{open} and \texttt{close} require the
    maintenance of file descriptor state.
...
\begin{frame}{Modelling a filesystem}
  \begin{itemize}
  \item What should our first filesystem model look like?
  \item A tree is a natural choice to model the directory structure.
  \item Let's look at an example, and create/add/delete files.
  \item This will be our running example, to show our design choices
    in future models.
  \end{itemize}
\end{frame}
...
\begin{frame}{Work in progress: permissions}
  \begin{itemize}
