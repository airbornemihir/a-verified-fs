...
;; This theorem uses a tough instantiation.
(defthm
  ...
  (("goal"
    :do-not-induct t
    :in-theory (e/d (hifat-place-file abs-place-file-helper)
...
(encapsulate
   ...
   (in-theory
    (e/d (abs-mkdir collapse 1st-complete
         ...
         ((:rewrite put-assoc-equal-without-change . 2)
          ...
          (:rewrite member-of-abs-addrs-when-natp . 2)
          (:definition hifat-file-alist-fix)
          (:rewrite abs-mkdir-correctness-lemma-105)
          (:type-prescription assoc-when-zp-len)
          (:rewrite
           abs-place-file-helper-of-ctx-app-lemma-1)
          (:rewrite abs-addrs-of-ctx-app-2)
  ...
  ;; These hypotheses are not minimised...
  (defthm
