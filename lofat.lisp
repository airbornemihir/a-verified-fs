...
;; I'm going to leave this alone, because it turns on
...
(defthm
  ...
  :hints
  (("goal"
    :in-theory (disable dir-ent-clusterchain-of-place-contents-coincident-2)
    :use
    ((:instance
...
(defthm
  ...
  (("goal"
    :in-theory
    (disable dir-ent-clusterchain-contents-of-place-contents-coincident-2)
    :use
    (:instance
...
(encapsulate
    ...
    (("goal"
      ...
      (e/d
       ...
       ((:rewrite
        ...
        (:rewrite lofat-place-file-correctness-1-lemma-10)
        (:rewrite subdir-contents-p-when-zero-length)
        (:linear lofat-to-hifat-helper-correctness-3)))
      :induct (induction-scheme dir-ent-list
                                entry-limit fat32-in-memory x)
    ...
    (implies
     ...
     (and
      ...
      (equal
       ...
       (put-assoc-equal
        filename
        (m1-file (dir-ent-set-first-cluster-file-size
                  (mv-nth 0 (find-dir-ent dir-ent-list filename))
                  0 0)
                 "")
        (mv-nth 0
  ...
  ;;       (dir-ent-clusterchain-contents fat32-in-memory root-dir-ent)))
  ;;     dir-ent-list)
  ;;    (equal pathname (list filename1 filename2)))
  ;;   :hints :none)
  ;;  (:=
  ;;   (make-dir-ent-list
  ;;    (mv-nth 0
  ;;            (dir-ent-clusterchain-contents fat32-in-memory root-dir-ent)))
  ;;   dir-ent-list)
  ;;  (:= pathname (list filename1 filename2))
  ;;  :drop :bash)
  ...
  (defthm
    ...
    (("goal"
      :in-theory
      (e/d
       (lofat-to-hifat-helper not-intersectp-list hifat-find-file)
       ((:rewrite
         dir-ent-clusterchain-contents-of-lofat-place-file-coincident-lemma-13
         . 1)
        (:rewrite lofat-place-file-correctness-1-lemma-13)
    ...
    (equal
     (mv-nth
      ...
      (lofat-to-hifat-helper
       ...
       dir-ent-list entry-limit))
     0)))
  :hints (("goal" :in-theory (disable lofat-place-file-correctness-1-lemma-40)
           :use (:instance lofat-place-file-correctness-1-lemma-40
                           (x nil)))))

(thm
 (implies
  (and (consp pathname)
       (equal (cdr pathname) nil)
       (fat32-filename-list-p pathname)
       (m1-regular-file-p file)
       (not (zp (mv-nth 1
                        (hifat-place-file fs pathname file)))))
 ...
 :hints (("goal" :do-not-induct t
          :expand (hifat-place-file fs pathname file))))
  ...
  (defun-nx
    ...
    (cond
     ((and
      ...
      (induction-scheme
       entry-limit
       fat32-in-memory file (cdr pathname)
       (mv-nth
        0
        (find-dir-ent
         (make-dir-ent-list
  ...
  (defthm
    ...
    (b*
        (;; I'm not very happy with this assigned value of dir-ent... and I'm
         ...
         (dir-ent
          (cond
           ((and dir-ent-exists dir-ent-clusterchain-exists
                 (zp (len (explode (lofat-file->contents file)))))
            (dir-ent-set-first-cluster-file-size
             (mv-nth
              0
              (find-dir-ent
            ...
            (dir-ent-set-first-cluster-file-size
             ...
             (nth 0
                  (find-n-free-clusters
                   ...
                   1))
             (len (explode (lofat-file->contents file)))))
           ((and dir-ent-exists (zp (len (explode (lofat-file->contents file)))))
            (dir-ent-set-first-cluster-file-size
             (mv-nth
              0
              (find-dir-ent
    ...
    (("goal"
      :induct
      (induction-scheme
       ENTRY-LIMIT FAT32-IN-MEMORY FILE PATHNAME ROOT-DIR-ENT X)
      :expand
      (lofat-place-file fat32-in-memory root-dir-ent pathname file)
      :in-theory
