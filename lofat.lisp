...
(defthm
  ...
  :hints
  (("goal"
    :in-theory (e/d ((:rewrite hifat-to-lofat-inversion-lemma-17))
...
(defthmd
  ...
  (equal (member-intersectp-equal e (cons x y))
         (or (not (not-intersectp-list x e))
             (member-intersectp-equal e y)))
  :hints
  (("goal"
    :in-theory
    (disable (:rewrite member-intersectp-binary-append)
             (:rewrite member-intersectp-is-commutative))
    :use ((:instance (:rewrite member-intersectp-binary-append)
                     (x (list x)))
          (:instance (:rewrite member-intersectp-is-commutative)
                     (y (list x))
                     (x e))))))
...
(defthm
  ...
  (("goal"
    ...
    (get-clusterchain-contents fat32-in-memory
                               masked-current-cluster length)
    :in-theory
    (e/d (get-clusterchain-contents fat32-build-index-list)
...
(defthm
  ...
  (implies
   ...
   (equal
    (lofat-to-hifat-helper-exec
     (stobj-set-indices-in-fa-table
      fat32-in-memory
      index-list (make-list-ac n 0 nil))
     dir-ent-list entry-limit)
    (lofat-to-hifat-helper-exec fat32-in-memory
                                dir-ent-list entry-limit)))
  :hints
  (("goal"
    ...
    (lofat-to-hifat-helper-exec fat32-in-memory
                                dir-ent-list entry-limit)
    :expand ((intersectp-equal nil x)
             (lofat-to-hifat-helper-exec
              (stobj-set-indices-in-fa-table
               fat32-in-memory index-list
...
(defthm
 ...
 (("goal"
    :induct t
    :in-theory
    (e/d (lofat-to-hifat-helper-exec dir-ent-list-p)
         ((:rewrite nth-of-effective-fat)
          (:definition no-duplicatesp-equal)
          (:definition assoc-equal)
          (:rewrite lofat-to-hifat-helper-exec-correctness-5-lemma-5
