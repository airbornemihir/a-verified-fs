...
;;   (("goal"
;;     :in-theory
;;     (e/d (make-dir-ent-list-of-remove1-dir-ent dir-ent-clusterchain-contents)
...
(defthm
  get-clusterchain-contents-of-lofat-remove-file-by-pathname-disjoint-lemma-17
  (implies
   (equal
    (mv-nth
     3
...
(encapsulate
  ...
  ;; (defthm
  ;;   get-clusterchain-contents-of-lofat-remove-file-by-pathname-disjoint-lemma-9
  ;;   (implies
  ;;    (and
  ;;     (not-intersectp-list
  ;;      x
...
;; (defthm
;;   get-clusterchain-contents-of-lofat-remove-file-by-pathname-disjoint-lemma-14
;;   (implies
;;    (and
;;     (dir-ent-directory-p
;;      (mv-nth
...
;; (defthm
;;   get-clusterchain-contents-of-lofat-remove-file-by-pathname-disjoint-lemma-15
;;   (implies
;;    (and
;;     (dir-ent-directory-p
;;      (mv-nth
...
(defthm
  dir-ent-clusterchain-contents-of-lofat-remove-file-by-pathname-disjoint
  (implies
   (and
    (lofat-fs-p fat32-in-memory)
    (<= *ms-first-data-cluster* rootclus)
...
(defthm
  ...
  (implies (equal (len (explode contents)) 0)
...
(defthm
  get-clusterchain-contents-of-lofat-remove-file-by-pathname-coincident-lemma-5
  (implies
   (and
    (dir-ent-list-p dir-ent-list)
    (<= 2
...
(defthm
  get-clusterchain-contents-of-lofat-remove-file-by-pathname-coincident-lemma-6
  (implies
   (and
    (dir-ent-directory-p
     (mv-nth
...
(defthm
  get-clusterchain-contents-of-lofat-remove-file-by-pathname-coincident-lemma-7
  (implies
   (and
    (dir-ent-directory-p
     (mv-nth
...
(defthm
  get-clusterchain-contents-of-lofat-remove-file-by-pathname-coincident-lemma-11
  (implies
   (and
    (dir-ent-directory-p
     (mv-nth
...
(defthm
  get-clusterchain-contents-of-lofat-remove-file-by-pathname-coincident-lemma-8
  (implies
   (and
    (dir-ent-directory-p
     (mv-nth
...
(defthm
  get-clusterchain-contents-of-lofat-remove-file-by-pathname-coincident-lemma-9
  (implies
   (and
    (dir-ent-directory-p
     (mv-nth
...
(defthm
  get-clusterchain-contents-of-lofat-remove-file-by-pathname-coincident-lemma-10
  (implies
   (and
    (dir-ent-directory-p
     (mv-nth
...
(defthm
  dir-ent-clusterchain-contents-of-lofat-remove-file-by-pathname-coincident
  (implies
   (and
    (lofat-fs-p fat32-in-memory)
    ...
    (equal
     (mv-nth 1
             (lofat-remove-file-by-pathname fat32-in-memory
                                            (dir-ent-first-cluster dir-ent)
                                            pathname))
     0)
    (equal
  ...
  (("goal"
    :in-theory
    (e/d
     (dir-ent-clusterchain-contents dir-ent-clusterchain)
     (get-clusterchain-contents-of-lofat-remove-file-by-pathname-coincident))
    :use
    (:instance
     get-clusterchain-contents-of-lofat-remove-file-by-pathname-coincident
     (rootclus (dir-ent-first-cluster dir-ent))))))
...
(defthmd
  lofat-to-hifat-helper-of-delete-dir-ent-2-lemma-1
  (implies
   (and
    (useful-dir-ent-list-p dir-ent-list)
    (<=
...
(encapsulate
  ...
  (local
   (defthm
     lofat-to-hifat-helper-of-delete-dir-ent-1-lemma-1
     (implies
      (and
       (<=
        0
  ...
  (local
   (defthm
     lofat-to-hifat-helper-of-delete-dir-ent-2-lemma-2
     (implies
     ...
     :hints
     (("goal"
       :expand ((intersectp-equal nil (car x)))
       :use
       ((:instance
  ...
  (local
   (defthm
     lofat-to-hifat-helper-of-delete-dir-ent-2-lemma-3
     (implies
      (and
       (not
        (member-intersectp-equal
     ...
     :hints
     (("goal"
       :in-theory (disable member-intersectp-binary-append)
       :use
       (:instance
        member-intersectp-binary-append
        (y (mv-nth 2
  ...
  (local
   (defthm
     lofat-to-hifat-helper-of-delete-dir-ent-2-lemma-4
     (implies
      (and
       (not
        (member-intersectp-equal
...
(defthm
  fat32-build-index-list-of-effective-fat-of-lofat-remove-file-by-pathname
  (implies
   (and
    (lofat-fs-p fat32-in-memory)
    (fat32-masked-entry-p rootclus)
...
(defthm
  dir-ent-clusterchain-of-lofat-remove-file-by-pathname
  (implies
   (and
    (lofat-fs-p fat32-in-memory)
    (fat32-masked-entry-p rootclus)
...
(defthm
  lofat-to-hifat-helper-after-delete-and-clear-2
  (implies
   (and (lofat-fs-p fat32-in-memory)
        (useful-dir-ent-list-p dir-ent-list)
        (equal (mv-nth 3
...
(defthm
  lofat-to-hifat-helper-after-delete-and-clear-3
  (implies
   (and (lofat-fs-p fat32-in-memory)
        (useful-dir-ent-list-p dir-ent-list)
        (equal (mv-nth 3
...
;; Could this theorem be unnecessary? We could have a theorem that's just about
;; deletion (delete-dir-ent ...) (maybe we already do) and a theorem about
;; (clear-clusterchain ...) which does nothing to the filesystem once the
;; deletion has happened.
(defthm
  lofat-to-hifat-helper-after-delete-and-clear-1
  (implies
   (and (lofat-fs-p fat32-in-memory)
        (useful-dir-ent-list-p dir-ent-list)
        (equal (mv-nth 3
   ...
   (and
    ...
    (equal
     ...
     0)))
  :hints
  (("goal" :in-theory (e/d (lofat-to-hifat-helper)
                           ((:rewrite nth-of-effective-fat)
                            (:definition member-equal)
                            (:rewrite
...
;; Actually a somewhat general theorem. One of many theorems which need to be
;; reverted to entry-limit from (- entry-limit 1) though.
(defthm
  lofat-to-hifat-helper-of-lofat-remove-file-by-pathname-disjoint-lemma-1
  (implies
   (and
    (not
     (member-intersectp-equal
...
(defthm
  lofat-to-hifat-helper-of-lofat-remove-file-by-pathname-disjoint-lemma-2
  (implies
   (and
    (dir-ent-directory-p
     (mv-nth
           ...
           (dir-ent-first-cluster
            (mv-nth
             ...
             (find-dir-ent
              ...
              (car pathname))))
           2097152)))))
      (entry-limit1 (+ -1 entry-limit2)))
     (:instance
      (:linear lofat-to-hifat-helper-correctness-3)
      (entry-limit (+ -1 entry-limit2))
      (dir-ent-list
       (make-dir-ent-list
        (string=>nats
         (mv-nth
...
(defthm
  lofat-to-hifat-helper-of-lofat-remove-file-by-pathname-disjoint-lemma-3
  (implies
   (and (integerp entry-limit)
        (useful-dir-ent-list-p dir-ent-list)
        (equal (mv-nth 3
...
;; This is one place where fat32-build-index-list and dir-ent-clusterchain
;; collide with each other.
(defthm
  lofat-to-hifat-helper-of-lofat-remove-file-by-pathname-disjoint-lemma-4
  (implies
   (and
    (not-intersectp-list
     (mv-nth 0
...
(defthm
  lofat-to-hifat-helper-of-lofat-remove-file-by-pathname-disjoint-lemma-5
  (implies
   (and
    (<=
     2
...
(defthm
  lofat-to-hifat-helper-of-lofat-remove-file-by-pathname-disjoint
  (implies
   (and
    (useful-dir-ent-list-p dir-ent-list)
    (lofat-fs-p fat32-in-memory)
  ...
  :hints
  (("goal"
    :induct (lofat-remove-file-by-pathname fat32-in-memory rootclus pathname))))
...
(local
 (defthm
   lofat-remove-file-by-pathname-correctness-1-lemma-36
   (implies
    (and
     (fat32-masked-entry-p masked-current-cluster)
     (>= masked-current-cluster
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-42
  (implies
   (and
    (dir-ent-directory-p
     (mv-nth
...
(encapsulate
  ...
  (local
   (defthm
     lofat-remove-file-by-pathname-correctness-1-lemma-43
     (implies
      (and
       (dir-ent-directory-p (car dir-ent-list))
       (lofat-fs-p fat32-in-memory)
          ...
          (len
           (remove1-dir-ent
            (remove1-dir-ent
             ...
             ".          ")
            "..         ")))
         (i2 (- (len (explode (mv-nth 0
                                      (dir-ent-clusterchain-contents
                                       fat32-in-memory (car dir-ent-list)))))
                64))))))))

  (defthm
    lofat-remove-file-by-pathname-correctness-1-lemma-44
    (implies
     (and (useful-dir-ent-list-p dir-ent-list)
          (lofat-fs-p fat32-in-memory)
          (equal (mv-nth 3
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-45
  (implies
   (and (useful-dir-ent-list-p dir-ent-list)
        (equal (mv-nth 3
                       (lofat-to-hifat-helper fat32-in-memory
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-49
  (implies
   (and
    (useful-dir-ent-list-p dir-ent-list)
    (equal (mv-nth 3
  ...
  (("goal"
    :in-theory
    (e/d
     (lofat-to-hifat-helper (:rewrite lofat-to-hifat-helper-correctness-4))
     ((:rewrite not-intersectp-list-of-lofat-to-hifat-helper)
      (:definition free-index-listp)
      (:rewrite nth-of-effective-fat)
      (:definition member-equal)))
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-51
  (implies
   (and
    (equal (mv-nth 3
                   (lofat-to-hifat-helper fat32-in-memory (cdr dir-ent-list)
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-54
  (implies
   (and
    (consp dir-ent-list)
    (dir-ent-directory-p
  ...
  (("goal"
    :in-theory
    (e/d
     (lofat-to-hifat-helper dir-ent-clusterchain-contents)
     ((:rewrite dir-ent-clusterchain-of-lofat-remove-file-by-pathname)
      (:rewrite
       get-clusterchain-contents-of-lofat-remove-file-by-pathname-coincident-lemma-5
       . 2)))
    :use
    ((:instance
     ...
     (:instance
      (:rewrite
       ...
       . 2)
      (dir-ent-list (cdr dir-ent-list)))
     (:instance (:rewrite lofat-to-hifat-helper-correctness-4)
                (entry-limit1 (- entry-limit 1))
                (entry-limit2 entry-limit)
                (dir-ent-list (cdr dir-ent-list))
                (fat32-in-memory fat32-in-memory))
     (:instance (:linear lofat-to-hifat-helper-correctness-3)
                (entry-limit (+ -1 entry-limit))
                (dir-ent-list (cdr dir-ent-list))
                (fat32-in-memory fat32-in-memory))
     (:instance
...
;; I've tried more than once to remove the proof-builder from this, but..
(defthm
...
(defthm
  ...
  (("goal"
    ...
    ((:instance
      ...
      (dir-ent (car dir-ent-list))
      (pathname pathname)
      (rootclus (dir-ent-first-cluster
                 (mv-nth 0
                         (find-dir-ent (cdr dir-ent-list)
                                       filename))))
      (fat32-in-memory fat32-in-memory)
...
;; For Subgoal *1/4.521.2'
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-58
  (implies
   (and
    (equal (mv-nth 3
                   (lofat-to-hifat-helper fat32-in-memory (cdr dir-ent-list)
...
;; For Subgoal *1/4.521.2'
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-59
  (implies
   (and
    (equal (mv-nth 3
                   (lofat-to-hifat-helper fat32-in-memory (cdr dir-ent-list)
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-62
  (implies
   (and
    (consp dir-ent-list)
    (dir-ent-directory-p (car dir-ent-list))
...
;; For Subgoal *1/4.267.13.2
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-63
  (implies
   (and
    (dir-ent-directory-p (car dir-ent-list))
    (equal
...
;; For Subgoal *1/4.287.3.2
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-64
  (implies
   (and
    (dir-ent-directory-p (car dir-ent-list))
    (equal
...
;; For Subgoal *1/4.287.3.2
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-65
  (implies
   (and
    (dir-ent-directory-p (car dir-ent-list))
    (equal
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-66
  (implies
   (and
    (dir-ent-directory-p (car dir-ent-list))
    (equal
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-46
  (implies
   (and
    (dir-ent-directory-p (car dir-ent-list))
    (equal
...
(defthm
  ...
  (("goal"
    :in-theory
    (e/d (dir-ent-clusterchain dir-ent-clusterchain-contents)
         (hifat-entry-count-of-lofat-to-hifat-helper-of-delete-dir-ent))
    :use
    ((:instance
      hifat-entry-count-of-lofat-to-hifat-helper-of-delete-dir-ent
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-70
  (implies
   (and
    (dir-ent-directory-p (car dir-ent-list))
    (equal
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-71
  (implies
   (and
    (dir-ent-directory-p (car dir-ent-list))
    (equal
...
(encapsulate
  ...
  ;; This is actually somewhat general. Also, this unwieldy set of hypotheses
  ;; is minimal.
  (defthm
    lofat-remove-file-by-pathname-correctness-1-lemma-73
    (implies
     (and (lofat-fs-p fat32-in-memory)
          (dir-ent-directory-p dir-ent)
          (<= *ms-first-data-cluster*
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-74
  (implies
   (and
    (dir-ent-directory-p (car dir-ent-list))
    (subdir-contents-p
  ...
  (("goal"
    ...
    :in-theory
    (e/d (dir-ent-clusterchain-contents)
         ((:linear lofat-remove-file-by-pathname-correctness-1-lemma-12)))
    :use
    (:instance (:linear lofat-remove-file-by-pathname-correctness-1-lemma-12)
               (rootclus (dir-ent-first-cluster (car dir-ent-list)))
               (fat32-in-memory fat32-in-memory))))
  :rule-classes :linear)
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-76
  (implies
   (and
    (dir-ent-directory-p (car dir-ent-list))
    (lofat-fs-p fat32-in-memory)
    (not
     (intersectp-equal
      ...
      (mv-nth 0
              (dir-ent-clusterchain fat32-in-memory (car dir-ent-list))))))
   (not (member-equal (dir-ent-first-cluster (car dir-ent-list))
                      x)))
  :hints
  (("goal"
    ...
    ((fat32-build-index-list (effective-fat fat32-in-memory)
     ...
     (:with
      ...
      (:free
       (y)
       (intersectp-equal x
                         (cons (dir-ent-first-cluster (car dir-ent-list))
                               y))))))))

;; Hypotheses are minimal.
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-57
  (implies
   (and
    (useful-dir-ent-list-p dir-ent-list)
    (lofat-fs-p fat32-in-memory)
  ...
  (("goal"
    ...
    :induct (mv (mv-nth 3
                        (lofat-to-hifat-helper fat32-in-memory
                                               dir-ent-list entry-limit))
                (mv-nth 1 (find-dir-ent dir-ent-list filename)))
    :expand
    ((lofat-to-hifat-helper
      (mv-nth
       0
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-77
  (implies
   (and
    (equal (mv-nth 3
                   (lofat-to-hifat-helper fat32-in-memory (cdr dir-ent-list)
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-78
  (implies
   (and
    (equal (mv-nth 3
                   (lofat-to-hifat-helper fat32-in-memory (cdr dir-ent-list)
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-79
  (implies
   (and
    (equal (mv-nth 3
                   (lofat-to-hifat-helper fat32-in-memory (cdr dir-ent-list)
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-80
  (implies
   (and
    (equal
     (mv-nth
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-81
  (implies
   (and
    (dir-ent-directory-p (car dir-ent-list))
    (equal
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-82
  (implies
   (and
    (dir-ent-directory-p (car dir-ent-list))
    (equal
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-83
  (implies
   (and
    (dir-ent-directory-p (car dir-ent-list))
    (equal
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-84
  (implies
   (and
    (dir-ent-directory-p (car dir-ent-list))
    (equal
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-85
  (implies
   (and
    (dir-ent-directory-p (car dir-ent-list))
    (equal
...
;; Hypotheses are minimal.
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-53
  (implies
   (and
    (useful-dir-ent-list-p dir-ent-list)
    (lofat-fs-p fat32-in-memory)
...
;;   (("goal" :in-theory (enable lofat-to-hifat-helper)
;;     :induct (mv (mv-nth 0
;;                         (lofat-to-hifat-helper fat32-in-memory dir-ent-list entry-limit))
;;                 (mv-nth 0
;;                         (find-dir-ent dir-ent-list filename)))
;;     :expand ((:free (x) (intersectp-equal nil x)) )) ))

(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-86
  (implies
   (and
    (useful-dir-ent-list-p dir-ent-list)
    (lofat-fs-p fat32-in-memory)
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-87
  (implies
   (and
    (not
     (not-intersectp-list
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-88
  (implies
   (and
    (not
     (equal
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-89
  (implies
   (and
    (useful-dir-ent-list-p dir-ent-list)
    (lofat-fs-p fat32-in-memory)
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-90
  (implies
   (and
    (useful-dir-ent-list-p dir-ent-list)
    (lofat-fs-p fat32-in-memory)
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-91
  (implies
   (and
    (useful-dir-ent-list-p dir-ent-list)
    (lofat-fs-p fat32-in-memory)
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-15
  (implies
   (and (integerp entry-limit)
        (useful-dir-ent-list-p dir-ent-list)
        (equal (mv-nth 3
...
;; One of a hopefully small number of lemmas to help with removing free
;; variables... (Subgoal *1/4.813.2')
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-94
  (implies
   (and
    (not (zp entry-limit))
    (not
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-29
  (implies
   (and
    (equal
     (mv-nth
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-16
  (implies
   (and
    (equal
     (mv-nth
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-17
  (implies
   (and
    (useful-dir-ent-list-p dir-ent-list)
    (equal
  ...
  :hints
  (("goal"
    :in-theory (enable lofat-to-hifat-helper-correctness-4)
    :cases
    ((atom
      (assoc-equal
       filename
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-18
  (implies
   (and
    (<= 0 (+ -1 entry-limit))
    (equal
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-19
  (implies
   (and
    (useful-dir-ent-list-p dir-ent-list)
    (equal
...
;; These hypotheses are minimised.
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-20
  (implies
   (and
    (useful-dir-ent-list-p dir-ent-list)
    (lofat-fs-p fat32-in-memory)
    (equal (mv-nth 3
                   (lofat-to-hifat-helper fat32-in-memory
                                          dir-ent-list entry-limit))
           0)
    (dir-ent-directory-p (mv-nth 0 (find-dir-ent dir-ent-list filename1)))
    (equal
     (mv-nth
      1
      (find-dir-ent
             ...
             (string=>nats
              (mv-nth
               ...
               (get-clusterchain-contents
                ...
                2097152))))
            filename2)))))
       (dir-ent-first-cluster (mv-nth 0 (find-dir-ent dir-ent-list filename1)))
       (nats=>string
        (clear-dir-ent
         (string=>nats
          (mv-nth 0
  ...
  (("goal"
    :in-theory
    (e/d (hifat-entry-count lofat-to-hifat-helper
                            dir-ent-clusterchain
                            dir-ent-clusterchain-contents)
         ((:rewrite m1-file-alist-p-of-cdr-when-m1-file-alist-p)
          (:definition hifat-file-alist-fix)
          ...
          (:rewrite get-clusterchain-contents-of-clear-clusterchain)))
    :induct (mv (mv-nth 0
                        (lofat-to-hifat-helper fat32-in-memory
                                               dir-ent-list entry-limit))
                (mv-nth 0 (find-dir-ent dir-ent-list filename1)))
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-21
  (implies
   (and
    (equal
     (mv-nth
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-22
  (implies
   (and
    (equal
     (mv-nth
...
(defthm
  ...
  (("goal"
    :in-theory
    (e/d (lofat-to-hifat-helper-correctness-4)
         ((:rewrite lofat-to-hifat-helper-after-delete-and-clear-2-lemma-2
                    . 2)))
    :use
    (:instance
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-24
  (implies
   (and
    (equal
     (mv-nth
...
;; This is proved...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-25
  (implies
   (and
    (useful-dir-ent-list-p dir-ent-list)
    (lofat-fs-p fat32-in-memory)
  ...
  (("goal"
    ...
    (e/d (hifat-entry-count lofat-to-hifat-helper
         ...
         ((:rewrite m1-file-alist-p-of-cdr-when-m1-file-alist-p)
          ...
          (:rewrite m1-file-p-of-cdar-when-m1-file-alist-p)
          (:definition binary-append)
          (:rewrite get-clusterchain-contents-of-update-dir-contents-disjoint)
          (:rewrite
           fat32-build-index-list-of-effective-fat-of-update-dir-contents)
          (:rewrite not-intersectp-list-of-lofat-to-hifat-helper)
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-34
  (implies
   (and
    (dir-ent-directory-p
     (mv-nth
  ...
  (:promote
   ...
   (:dive 1 2 2 1 1 2)
   := :top (:dive 1)
   (:claim (dir-ent-list-p dir-ent-list))
   (:rewrite
    (:rewrite
     get-clusterchain-contents-of-lofat-remove-file-by-pathname-disjoint-lemma-1
     . 2))
   ...
   (:rewrite
    ...
    ((entry-limit (+ -1 entry-limit))))
   :top :bash
   (:bash ("goal" :in-theory (enable lofat-to-hifat-helper-correctness-4)))
   (:dive 1)
   (:claim
    (and
     (not-intersectp-list
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-35
  (implies
   (and
    (<= 2
        (dir-ent-first-cluster (car dir-ent-list)))
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-39
  (implies
   (and (useful-dir-ent-list-p dir-ent-list)
        (equal (mv-nth 3
                       (lofat-to-hifat-helper fat32-in-memory
  ...
  (("goal"
    :in-theory (enable lofat-to-hifat-helper)
    :induct (mv (mv-nth 0 (find-dir-ent dir-ent-list filename))
                (mv-nth 3
                        (lofat-to-hifat-helper fat32-in-memory
                                               dir-ent-list entry-limit)))))
  :rule-classes
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-40
  (implies
   (and
    (equal
     (len
...
(defthm
  lofat-remove-file-by-pathname-correctness-1-lemma-41
  (implies
   (and
    (lofat-fs-p fat32-in-memory)
    (equal
    ...
    (and
     ...
     (equal (mv-nth 3
                    (lofat-to-hifat-helper fat32-in-memory (cdr dir-ent-list)
                                           entry-limit))
            0)
     (dir-ent-list-p (cdr dir-ent-list)))
    :hints :none)
   (:rewrite
    (:rewrite
     lofat-to-hifat-helper-of-lofat-remove-file-by-pathname-disjoint-lemma-1
...
(defthm
   ...
   (and
    ...
    (dir-ent-directory-p (mv-nth 0
                                 (find-dir-ent (cdr dir-ent-list)
                                               filename)))
    (equal
     (dir-ent-clusterchain-contents fat32-in-memory2
                                    (mv-nth 0
                                            (find-dir-ent (cdr dir-ent-list)
                                                          filename)))
     (dir-ent-clusterchain-contents fat32-in-memory1
                                    (mv-nth 0
                                            (find-dir-ent (cdr dir-ent-list)
                                                          filename)))))
   (>
  ...
  (:promote
   ...
   (:rewrite lofat-to-hifat-helper-correctness-4
             ((entry-limit1 (+ -1 entry-limit))))
   :top :bash :bash (:dive 1 2 2 1 1 2)
   (:= (dir-ent-clusterchain-contents fat32-in-memory2
                                      (mv-nth '0
                                              (find-dir-ent (cdr dir-ent-list)
                                                            filename))))
     ...
     (mv-nth
      ...
      (lofat-to-hifat-helper
       ...
       (make-dir-ent-list
        (string=>nats (mv-nth 0
                              (dir-ent-clusterchain-contents
                               fat32-in-memory2 (car dir-ent-list)))))
       (+
        (hifat-entry-count
         (mv-nth
          0
        ...
        (hifat-entry-count
         (mv-nth
          0
          (lofat-to-hifat-helper
           fat32-in-memory1 (cdr dir-ent-list)
           (+
            -1 entry-limit
            (-
             (hifat-entry-count
...
(defthm
  narrow-down-lemma-17
  (implies
   (and
    (equal (lofat-to-hifat-helper fat32-in-memory2 (cdr dir-ent-list)
                                  (+ -1 entry-limit))
           (lofat-to-hifat-helper fat32-in-memory1 (cdr dir-ent-list)
                                  (+ -1 entry-limit)))
    (useful-dir-ent-list-p dir-ent-list)
    (equal
     (mv-nth
      3
      (lofat-to-hifat-helper
       fat32-in-memory2 (cdr dir-ent-list)
       (hifat-entry-count
        (mv-nth 0
                (lofat-to-hifat-helper fat32-in-memory1 (cdr dir-ent-list)
                                       (+ -1 entry-limit))))))
...
(encapsulate
  ...
  (defthm
    narrow-down-lemma-14
    (b*
        (((mv m1-file-alist1 &
              clusterchain-list1 error-code1)
          (lofat-to-hifat-helper
           fat32-in-memory1 dir-ent-list entry-limit)))
      (implies
       (and
        (useful-dir-ent-list-p dir-ent-list)
        ;; all's good with fat32-in-memory1.
        (equal error-code1 0)
        (equal
         (mv-nth 3
                 (lofat-to-hifat-helper
                  fat32-in-memory2 dir-ent-list
       ...
       (equal
        (lofat-to-hifat-helper
         fat32-in-memory2 (delete-dir-ent dir-ent-list filename) entry-limit)
        (lofat-to-hifat-helper
         fat32-in-memory1 (delete-dir-ent dir-ent-list filename) entry-limit))))
    :hints (("goal"
             :induct
             (mv
              (mv-nth 0
...
(encapsulate
  ...
  (defthm narrow-down
    (implies
     (and (lofat-fs-p fat32-in-memory1)
          (lofat-fs-p fat32-in-memory2)
          (natp entry-limit)
          (useful-dir-ent-list-p dir-ent-list)
          (equal (mv-nth 3
                         (lofat-to-hifat-helper
...
(encapsulate
  ...
  (local
   (defun-nx
     induction-scheme
     (dir-ent-list entry-limit fat32-in-memory filename pathname)
     ...
     (if
         ...
         (induction-scheme
          ...
          (car pathname)
          (cdr pathname))
       (mv dir-ent-list entry-limit fat32-in-memory filename pathname))))

  (defthm
    lofat-remove-file-by-pathname-correctness-1-lemma-96
    (implies
        ...
        (lofat-to-hifat-helper
         ...
         (hifat-entry-count
          (mv-nth 0
                  (lofat-to-hifat-helper fat32-in-memory
                                         dir-ent-list entry-limit)))))))
     :hints (("goal" :induct (mv
                              (mv-nth 0
                                      (lofat-to-hifat-helper fat32-in-memory
                                                             dir-ent-list
                                                             entry-limit))
                              (mv-nth 0 (find-dir-ent dir-ent-list filename)))
              :in-theory (e/d (lofat-to-hifat-helper hifat-entry-count)
                              ((:definition clear-dir-ent)
                               (:rewrite
                                not-intersectp-list-of-lofat-to-hifat-helper)
                               (:rewrite take-of-len-free)
                               (:REWRITE
                                M1-FILE-ALIST-P-OF-CDR-WHEN-M1-FILE-ALIST-P)
                               (:DEFINITION LOFAT-REMOVE-FILE-BY-PATHNAME)
                               (:REWRITE
                                GET-CLUSTERCHAIN-CONTENTS-OF-LOFAT-REMOVE-FILE-BY-PATHNAME-COINCIDENT-LEMMA-11)))
              :expand (:free (fat32-in-memory entry-limit)
                             (lofat-to-hifat-helper fat32-in-memory
...
;; is per the recursive definition of lofat-remove-file-by-pathname or
...
;; decided a while ago that treating an empty list as a pointer to the current
;; directory was problematic because we would need to update the dir-ent-list
;; in the parent directory.
;; - If pathname had a single element, then we would search for the eponymous
;; file in the current directory (returning an error if it wasn't there.) We
;; would clear the file's clusters in the file allocation table and delete its
;; entry from this directory's entry list. This would happen the same way
;; whether it was a regular file or a directory.
;; - The weird stuff happens when pathname has at least two elements, and a
;; directory with the name of (car pathname) exists (if it did not exist, or if
;; only a regular file of that name exists, we would have an error.) Here, our
;; induction scheme gives us the proper shape for the subdirectory, but it's a
...
;; can offer only the same value of entry-limit. This leads to all manner of
;; awful rewrite rules because entry-limit decrements in an odd way after
;; passing by a directory entry for a subdirectory, and syntactically matching
;; a rewrite rule to that kind of decrement is a pain in the neck. It's not
;; something that can easily be abstracted away into a disabled function,
;; because it's a recursive call to the same function. For the same reason, it
;; doesn't seem easy to make some kind of set of rewrite rules to address
;; each possible branch, which is otherwise a nice way to avoid case
;; splits.
;; So what's the way out? It seems like (hifat-entry-count (mv-nth 0 ...))
;; would have to explicitly be the argument a lot of the time - but it doesn't
;; seem like there's another way. The issue is that the rewrite rules will get
;; complicated.
