...
(defthm
  ...
  (("goal"
    :do-not-induct t
    :in-theory
    (disable (:linear lofat-find-file-by-pathname-correctness-1-lemma-6))
    :use
    ((:instance
      lofat-to-hifat-helper-correctness-4
      (entry-limit1 entry-limit)
      (entry-limit2 (- entry-limit 1))
     ...
     (:instance (:linear lofat-find-file-by-pathname-correctness-1-lemma-6)
  ...
  (implies
   (and
    (<= 2
        (dir-ent-first-cluster (car dir-ent-list)))
    (< (dir-ent-first-cluster (car dir-ent-list))
       (+ 2 (count-of-clusters fat32-in-memory1)))
    (equal (count-of-clusters fat32-in-memory2)
           (count-of-clusters fat32-in-memory1))
    (equal
     (mv-nth 0
             (dir-ent-clusterchain fat32-in-memory2 (car dir-ent-list)))
     (mv-nth 0
             (dir-ent-clusterchain fat32-in-memory1 (car dir-ent-list))))
    (equal
     (mv-nth
      1
      (dir-ent-clusterchain-contents fat32-in-memory2 (car dir-ent-list)))
     0))
   (non-free-index-listp
    (mv-nth 0
            (dir-ent-clusterchain fat32-in-memory1 (car dir-ent-list)))
    (effective-fat fat32-in-memory2)))
  :hints
  (("goal"
    :in-theory
    (disable (:rewrite non-free-index-listp-of-dir-ent-clusterchain))
    :use (:instance (:rewrite non-free-index-listp-of-dir-ent-clusterchain)
                    (dir-ent (car dir-ent-list))
                    (fat32-in-memory fat32-in-memory2)))))
   ...
   (and
    ...
    (implies
     (and
      ...
      (not-intersectp-list
       (mv-nth 0
               (dir-ent-clusterchain fat32-in-memory2
                                     (mv-nth 0
                                             (find-dir-ent (cdr dir-ent-list)
                                                           filename))))
       (mv-nth 2
...
(encapsulate
  ...
  ;; We have a lot of use hints because doing it the proper way - by rewrite
  ;; rules - causes things to be rewritten in a way that doesn't make sense.
  (defthm lofat-remove-file-correctness-1-lemma-12
    (implies
     (and
      (lofat-fs-p fat32-in-memory)
      (useful-dir-ent-list-p dir-ent-list)
...
(defthm lofat-remove-file-correctness-1-lemma-15
  (implies
   (and
    (lofat-fs-p fat32-in-memory)
    (dir-ent-list-p dir-ent-list)
