...
(defthm lofat-to-m1-fs-helper-correctness-1-lemma-1
  (equal (rationalp (nth n (dir-ent-fix x)))
         (< (nfix n) *ms-dir-ent-length*)))

(defthm
  lofat-to-m1-fs-helper-correctness-1
  ...
  (("goal"
    :in-theory
    (e/d (fat32-filename-p lofat-to-m1-fs-helper)
         (nth-of-string=>nats
          natp-of-cluster-size take-redefinition))
    :induct
    (lofat-to-m1-fs-helper fat32-in-memory
                                     dir-ent-list entry-limit)))
  :rule-classes
  ((:type-prescription
...
(defthm
  lofat-to-m1-fs-helper-correctness-2-lemma-1
...
(defthm
  lofat-to-m1-fs-helper-correctness-2
  (implies (useful-dir-ent-list-p dir-ent-list)
           (b* (((mv m1-file-alist & & &)
                 (lofat-to-m1-fs-helper
                  fat32-in-memory
  ...
  (("goal"
    ...
    (e/d (fat32-filename-p useless-dir-ent-p
         ...
         (nth-of-string=>nats natp-of-cluster-size
                              take-redefinition))
    :induct (lofat-to-m1-fs-helper
             fat32-in-memory
             dir-ent-list entry-limit))))

(defthm
  lofat-to-m1-fs-helper-correctness-3
  (b* (((mv m1-file-alist entry-count & &)
        (lofat-to-m1-fs-helper
         fat32-in-memory
         dir-ent-list entry-limit)))
  ...
  :hints
  (("goal" :in-theory (enable lofat-to-m1-fs-helper m1-entry-count)))
  :rule-classes
  (:rewrite
   (:linear
    :corollary (b* (((mv m1-file-alist & & &)
    ...
    (("goal"
      :in-theory
      (disable lofat-to-m1-fs-helper-correctness-1)
      :use lofat-to-m1-fs-helper-correctness-1)))))

(defthmd
  lofat-to-m1-fs-helper-correctness-4
  (implies
   (and (equal (mv-nth 3
                       (lofat-to-m1-fs-helper
                        fat32-in-memory
   ...
   (equal
    ...
    (lofat-to-m1-fs-helper
     ...
     dir-ent-list entry-limit1)))
  :hints
  (("goal" :in-theory (enable lofat-to-m1-fs-helper
                              m1-entry-count)))
  :rule-classes
  ((:rewrite
    :corollary
...
(defthm true-listp-of-lofat-to-m1-fs-helper
  (true-listp (mv-nth 2
                      (lofat-to-m1-fs-helper
                       fat32-in-memory
  ...
  (implies
   (equal
    (mv-nth
      ...
      *ms-max-dir-size*))
    "")
   (equal (mv-nth 0 (lofat-to-m1-fs fat32-in-memory))
          nil))
  :hints
  (("goal"
    :in-theory
    (enable lofat-to-m1-fs lofat-to-m1-fs-helper))))

(defthm
  m1-entry-count-of-lofat-to-m1-fs
  (implies
   (lofat-fs-p fat32-in-memory)
   (<= (m1-entry-count
        (mv-nth 0
                (lofat-to-m1-fs fat32-in-memory)))
       (max-entry-count fat32-in-memory)))
  :hints (("goal" :in-theory (enable lofat-to-m1-fs)))
  :rule-classes :linear)
...
;; m1-fs-to-lofat-helper), we need to make a recursive call to get
  ...
  (b*
      (;; This is the base case; no directory entries are left. Return an error
       ...
       ((mv fat32-in-memory tail-list errno tail-index-list)
        (m1-fs-to-lofat-helper fat32-in-memory (cdr fs)
...
(defthm
  cluster-size-of-m1-fs-to-lofat-helper
  (equal
...
(defthm
  count-of-clusters-of-m1-fs-to-lofat-helper
  (equal
   (count-of-clusters
    (mv-nth 0
            (m1-fs-to-lofat-helper
...
(defthm natp-of-m1-fs-to-lofat-helper
  (natp (mv-nth 2
                (m1-fs-to-lofat-helper
                 fat32-in-memory
                 fs current-dir-first-cluster)))
...
(defthm
  data-region-length-of-m1-fs-to-lofat-helper
  (equal
   (data-region-length
    (mv-nth 0
            (m1-fs-to-lofat-helper
...
(defthm
  bpb_rootclus-of-m1-fs-to-lofat-helper
  (equal
   (bpb_rootclus
    (mv-nth 0
            (m1-fs-to-lofat-helper
...
(defthm
  fat-length-of-m1-fs-to-lofat-helper
  (equal
   (fat-length (mv-nth 0
                       (m1-fs-to-lofat-helper
...
(defthm
  lofat-fs-p-of-m1-fs-to-lofat-helper-lemma-1
  (implies
   (lofat-fs-p fat32-in-memory)
   (and
    (not (< (binary-+ '2
...
(defthm
  lofat-fs-p-of-m1-fs-to-lofat-helper
  (implies
   (lofat-fs-p fat32-in-memory)
   (lofat-fs-p
    (mv-nth 0
...
(defthm
  dir-ent-list-p-of-m1-fs-to-lofat-helper
  (dir-ent-list-p
   (mv-nth 1
           (m1-fs-to-lofat-helper
            fat32-in-memory fs first-cluster))))
...
(defthm
  useful-dir-ent-list-p-of-m1-fs-to-lofat-helper
  (implies
   (m1-file-alist-p fs)
   (useful-dir-ent-list-p
    (mv-nth 1
...
(defthmd
  m1-fs-to-lofat-helper-correctness-4
  (implies
...
(defthm
  true-listp-of-m1-fs-to-lofat-helper
  (true-listp (mv-nth 3
                      (m1-fs-to-lofat-helper
                       fat32-in-memory
                       fs current-dir-first-cluster))))
...
(encapsulate
  ...
  (local
   (defthm
     m1-fs-to-lofat-helper-guard-lemma-1
  ...
  (local
   (defthm
     m1-fs-to-lofat-helper-guard-lemma-2
     (implies (unsigned-byte-listp 8 x)
              (true-listp x))))

  (defthm
    m1-fs-to-lofat-helper-guard-lemma-3
    (implies
     (lofat-fs-p fat32-in-memory)
     (not
      (<
...
(defthm
  max-entry-count-of-m1-fs-to-lofat-helper
  (equal
   (max-entry-count
    (mv-nth
     0
     (m1-fs-to-lofat-helper fat32-in-memory
                                      fs current-dir-first-cluster)))
   (max-entry-count fat32-in-memory)))

(defthmd
  m1-fs-to-lofat-guard-lemma-1
  (implies
   (lofat-fs-p fat32-in-memory)
   (iff
    (< (binary-+
  ...
  (declare
   (xargs
    ...
    :guard (and (lofat-fs-p fat32-in-memory)
                (m1-file-alist-p fs))
    :guard-hints
    (("goal" :in-theory (e/d (m1-fs-to-lofat-guard-lemma-1
                              lofat-fs-p-of-update-fati)
                             (unsigned-byte-p))
    ...
    (<= 0
        (mv-nth 1
                (m1-fs-to-lofat
                 fat32-in-memory
                 fs)))))
  :hints (("Goal" :in-theory (enable m1-fs-to-lofat)) ))

(defthm
  lofat-fs-p-of-m1-fs-to-lofat
  (implies
   (and (lofat-fs-p fat32-in-memory)
        (m1-file-alist-p fs))
   (lofat-fs-p
  ...
  :hints
  (("goal"
    :in-theory (enable m1-fs-to-lofat
                       m1-fs-to-lofat-guard-lemma-1
                       lofat-fs-p-of-update-fati)
    :do-not-induct t
    :cases
...
(defthm
  lofat-to-m1-fs-helper-of-place-contents-lemma-1
  (implies
   (and
    (lofat-fs-p fat32-in-memory)
...
(defthm
  lofat-to-m1-fs-helper-of-place-contents
  (implies
   (and (lofat-fs-p fat32-in-memory)
        (stringp contents)
        (integerp first-cluster)
...
(defthm
  lofat-to-m1-fs-helper-of-update-fati
  (implies
   (and (lofat-fs-p fat32-in-memory)
        (dir-ent-list-p dir-ent-list)
        (< (nfix i)
...
(defthm
  fati-of-m1-fs-to-lofat-helper-disjoint-lemma-1
  (implies
   (and
    (equal
     (len
      (find-n-free-clusters
       (effective-fat
        (mv-nth 0
                (m1-fs-to-lofat-helper fat32-in-memory fs
                                                 current-dir-first-cluster)))
       1))
     1)
    (equal
...
(defthm
  fati-of-m1-fs-to-lofat-helper-disjoint
  (implies
   (and (lofat-fs-p fat32-in-memory)
        (integerp x)
...
(defthm
  lofat-to-m1-fs-helper-of-m1-fs-to-lofat-helper-disjoint-lemma-1
  (implies
   (and (lofat-fs-p fat32-in-memory)
        (natp n)
        (equal (mv-nth 3
  ...
  (("goal"
    :in-theory
    (e/d (intersectp-equal lofat-to-m1-fs-helper)
         ((:definition fat32-build-index-list)))))
  :rule-classes
  (:rewrite
   (:rewrite
...
(defthm
  lofat-to-m1-fs-helper-of-m1-fs-to-lofat-helper-disjoint
  (implies
   (and (lofat-fs-p fat32-in-memory)
        (equal (mv-nth 3
                       (lofat-to-m1-fs-helper
...
(defthm
  m1-fs-to-lofat-inversion-lemma-1
  (implies
...
;; around it.
(defthm
  m1-fs-to-lofat-inversion-lemma-2
...
(defthm
  m1-fs-to-lofat-inversion-lemma-3
  (implies
   (not-intersectp-list
    (cons
     (nth
...
(encapsulate
  ...
  (defthm
    m1-fs-to-lofat-inversion-big-induction
    (implies
     (and (lofat-fs-p fat32-in-memory)
          (m1-file-alist-p fs)
...
(defthm
  m1-fs-to-lofat-inversion-big-induction-corollaries
  (implies
   (and (lofat-fs-p fat32-in-memory)
        (m1-file-alist-p fs)
        (m1-bounded-file-alist-p fs)
  ...
  :hints
  (("goal"
    :in-theory (disable m1-fs-to-lofat-inversion-big-induction)
    :use
    (:instance m1-fs-to-lofat-inversion-big-induction
               (x nil)))))

(defthmd m1-fs-to-lofat-inversion-lemma-10
  (implies
   (atom dir-ent-list)
   (equal
    (lofat-to-m1-fs-helper fat32-in-memory
                                     dir-ent-list entry-limit)
    (mv nil 0 nil 0)))
  :hints (("goal" :in-theory (enable lofat-to-m1-fs-helper)) ))

(defthmd
  m1-fs-to-lofat-inversion-lemma-11
  (implies
   (lofat-fs-p fat32-in-memory)
   (and
    (< (fat32-entry-mask (bpb_rootclus fat32-in-memory))
...
(encapsulate
  ...
  (defthm
    m1-fs-to-lofat-inversion-lemma-12
    (implies (lofat-fs-p fat32-in-memory)
             (>= *ms-max-dir-size*
                 (cluster-size fat32-in-memory)))
    :rule-classes :linear
  ...
  (defthmd
    m1-fs-to-lofat-inversion-lemma-13
    (implies
     (and (lofat-fs-p fat32-in-memory)
          (stringp text)
          (equal (length text)
...
(defthm
  ...
  :hints
  (("goal" :do-not-induct t
    :in-theory (enable lofat-to-m1-fs
                       m1-fs-to-lofat
                       m1-fs-to-lofat-helper-correctness-4
                       m1-fs-to-lofat-inversion-lemma-10
                       m1-fs-to-lofat-inversion-lemma-11
                       m1-fs-to-lofat-inversion-lemma-13
...
(defund-nx
  ...
  (b* (((mv fs1 error-code1)
       ...
       (good1 (and (lofat-fs-p fat32-in-memory1)
                   (equal error-code1 0)))
       ((mv fs2 error-code2)
        (lofat-to-m1-fs fat32-in-memory2))
   ...
   (b*
     ...
     (implies
      (and
       ...
       ;; m1-fs-to-lofat-helper (and the wrapper) is when we run out
...
(b* (((mv dir-contents &)
      (get-clusterchain-contents fat32-in-memory 2 *ms-max-dir-size*))
     (fs (lofat-to-m1-fs fat32-in-memory)))
...
;; lofat-to-m1-fs-helper doesn't fix its arguments. Should it?
(defthm
  ...
  :hints
  (("goal"
    :in-theory (enable lofat-to-m1-fs-helper))))
...
(defthm
  ...
  :hints
  (("goal" :in-theory
    (enable lofat-to-m1-fs-helper-correctness-4
            lofat-to-m1-fs-helper))))
