...
(defthm
  dir-ent-clusterchain-of-place-contents-coincident
  (implies
   (and (lofat-fs-p fat32-in-memory)
        (stringp contents)
        (dir-ent-directory-p dir-ent)
        ...
        (not (equal (fat32-entry-mask (fati (dir-ent-first-cluster dir-ent)
                                            fat32-in-memory))
                    0)))
   (equal
    (dir-ent-clusterchain
    ...
    (if
     (equal (mv-nth 2
                    (place-contents fat32-in-memory
                                    ...
                                    (dir-ent-first-cluster dir-ent)))
            0)
     (mv (list* (dir-ent-first-cluster dir-ent)
  ...
  (("goal"
    :in-theory
    (e/d (place-contents dir-ent-clusterchain)
         ((:rewrite
...
(encapsulate
  ...
  (make-event
   `(defthm
      ...
      :hints
      (("goal"
        :in-theory (disable (:rewrite lofat-remove-file-correctness-1-lemma-36))
        :use
        (:instance
...
(defthm
  ...
  :hints (("goal" :in-theory (disable lofat-remove-file-correctness-1-lemma-72)
           :use (:instance lofat-remove-file-correctness-1-lemma-72
                           (x nil)))))
