...
(defthm
  ...
  (("goal"
    ...
    :use ((:instance (:rewrite nth-of-set-indices-in-fa-table-when-member)
                     (val 0)
                     (index-list (mv-nth 0 (d-e-cc fat32$c d-e)))
                     (fa-table (effective-fat fat32$c))
                     (n i))
          (:instance
           (:rewrite set-indices-in-fa-table-correctness-3)
           (value-list (make-list-ac (len (mv-nth 0 (d-e-cc fat32$c d-e)))
                                     0 nil))
           (index-list (mv-nth 0 (d-e-cc fat32$c d-e)))
           (fa-table (effective-fat fat32$c))
           (n i))))))
