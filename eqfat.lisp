  ...
  (defthm lofat-place-file-correctness-lemma-152
    (implies (and (integerp x) (equal (mod x 32) 0))
             (equal (mod (binary-+ x (binary-* 32 (len y)))
                    ...
                    0))
    :hints (("goal" :do-not-induct t
             :in-theory (disable lofat-place-file))))
...
;; I hope to get rid of this when the congruence rule works...
(defthm
    ...
    ((fs2
      (mv-nth
       ...
       (hifat-place-file
        ...
        (m1-file-hifat-file-alist-fix nil nil))))))
   :top
   :bash (:bash ("goal" :in-theory (disable lofat-place-file)))))
