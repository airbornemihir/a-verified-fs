...
involving multiple reads and writes.
...
complicated induction schemes. For reference, code listing 42 shows
...
previous model. A representation of such an equivalence proof follows.
...
%% function brought down the compilation time for l4 from 20 seconds to and the
%% that for l6 from 84 seconds to .
It is interesting to note that disabling l6-wrchs brought down the
