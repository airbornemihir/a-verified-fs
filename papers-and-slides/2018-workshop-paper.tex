...
of these theorems follow. Note, the hypothesis \texttt{(stringp
  (l1-stat hns fs))} stipulates that a regular file should exist at
the path \texttt{hns}, where \texttt{l1-stat} is a function for
traversing a directory tree to look up a regular file or a directory
at a given path.
