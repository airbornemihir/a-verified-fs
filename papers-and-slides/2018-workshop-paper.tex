...
looking up the contents of these clusters in the data region. Unused
    ...
    \matrix (m) [matrix of math nodes,row sep=3em,column sep=4em,minimum width=2em]
            {
              ...
              l2 & l2 \\};
            \path[-stealth]
            (m-2-1) edge node [left] {l2-to-l1-fs} (m-1-1)
            edge node [below] {write} (m-2-2)
            (m-1-1.east|-m-1-2) edge node [below] {write} (m-1-2)
            (m-2-2) edge node [left] {l2-to-l1-fs} (m-1-2);
  \end{tikzpicture}
\end{figure}
...
\begin{figure}
  ...
  \begin{tikzpicture}
    \matrix (m) [matrix of math nodes,row sep=3em,column sep=4em,minimum width=2em]
            ...
            \path[-stealth]
            (m-2-1) edge node [left] {l2-to-l1-fs} (m-1-1)
            edge node [below] {read} (m-2-2)
            (m-1-1.east|-m-1-2) edge node [above] {read} (m-2-2);
  \end{tikzpicture}
\end{figure}
...
\begin{figure}
  ...
  \begin{tikzpicture}
    \matrix (m) [matrix of math nodes,row sep=3em,column sep=4em,minimum width=2em]
            ...
            (m-1-1.east|-m-1-2) edge node [below] {write} (m-1-2)
            (m-2-2) edge node [left] {l2-to-l1-fs} (m-1-2)
            edge node [below] {read} (m-2-3)
            (m-1-2.east) edge node [above] {read} (m-2-3);
  \end{tikzpicture}
\end{figure}
