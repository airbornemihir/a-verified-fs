...
\texttt{L6}. These models are constructed incrementally to allow for
reuse of features in general, and a refinement relation where
possible. Much of the code and proof infrastructure is shared between
the abstract models and the concrete models by design, although there
is not a formal refinement relation between the latter and the former.
