...
(defthm
  ...
  (("goal"
    :in-theory
    (e/d
     (lofat-fs-p fat32-in-memoryp update-fati fat-length
                 count-of-clusters data-region-length)
     (cluster-size-of-update-fati
      ...
      (:rewrite product-less-than-zero)
      (:rewrite unary-divide-less-than-zero)
      (:rewrite rearr-negative-coeffs-<-sums-blah)
      (:rewrite complex-rationalp-prod)
      (:rewrite rationalp-unary-divide)
