...
(defthm find-n-free-clusters-helper-correctness-5
  (equal (find-n-free-clusters-helper fa-table 0 start) nil)
...
(defthm find-n-free-clusters-correctness-5
  (equal (find-n-free-clusters fa-table 0) nil)
...
(defthm
  l6-file-index-list-correctness-4
   ...
   (:rewrite
    ...
    (implies
     ...
     (iff (consp (find-n-free-clusters fa-table n))
          (not (or (equal (count-free-blocks (fa-table-to-alv fa-table))
                          0)
                   (equal n 0)))))
    :hints (("goal" :expand (len (find-n-free-clusters fa-table n)))))
   (:rewrite
    :corollary
    (implies (and (>= (len fa-table)
                      *ms-first-data-cluster*)
