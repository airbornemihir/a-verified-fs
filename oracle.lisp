     ...
     (not-intersectp-list
      (find-n-free-clusters
       (update-nth
        (d-e-first-cluster (pseudo-root-d-e fat32$c))
        (fat32-update-lower-28
         (fati (d-e-first-cluster (pseudo-root-d-e fat32$c))
               fat32$c)
         268435455)
        (set-indices-in-fa-table
  ...
  (defthm
    ...
    (("goal"
     ...
     (if (not stable-under-simplificationp)
         nil
         '(:in-theory (enable lofat-place-file))))
    :otf-flg t))
...
(thm
 ...
 (("goal"
   ...
   :in-theory
   (e/d (lofat-to-hifat)
        (lofat-mkdir-refinement-lemma-10 lofat-place-file))
   :use lofat-mkdir-refinement-lemma-10))
 :otf-flg t)
