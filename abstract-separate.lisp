...
(defthm member-of-frame-addrs-before-lemma-1
...
(defthm
  ...
  :hints
  (("goal"
    :in-theory (e/d (collapse collapse-this) (partial-collapse-correctness-lemma-27))
    :use
...
;;                            ((:rewrite partial-collapse-correctness-lemma-27)
;;                             partial-collapse-correctness-lemma-1))
     ...
     (abs-addrs
      (frame-val->dir$inline
       (cdr (assoc-equal (1st-complete (frame->frame (collapse-this frame x)))
                         (frame->frame frame))))))))
  :hints
  (("goal" :in-theory (e/d (collapse collapse-this) (partial-collapse-correctness-lemma-27))
...
(defthm
  ...
  (("goal" :in-theory (e/d (valid-seqp collapse-seq))
    :use (:rewrite partial-collapse-correctness-lemma-95))))
...
(defthm
  ...
  :hints
  (("goal"
    :in-theory (disable partial-collapse-correctness-lemma-103)
    :use
    (:instance
     partial-collapse-correctness-lemma-103
     (x (nth (binary-+ -1 n)
...
(defthm
  ...
  (("goal"
    :do-not-induct t
    :in-theory (disable
                (:linear partial-collapse-correctness-lemma-102))
    :use (:instance
          (:linear partial-collapse-correctness-lemma-102)
          (seq seq)
          (frame frame)
...
(defthm
  ...
  (("goal"
    ...
    ((:instance
     ...
     (:instance
      (:rewrite subsetp-of-binary-append-3)
      (z (frame-addrs-before-seq frame
                                 x (take (position-equal x seq) seq)))
      (y
       (nthcdr
        (+ -1 n)
...
(defthm
  partial-collapse-correctness-lemma-178
  (implies
   (mv-nth 1
           (ctx-app-list-seq (frame->root frame)
                             nil frame
...
(defthm
  partial-collapse-correctness-lemma-181
  (implies
   (and
    (mv-nth 1
            (ctx-app-list (frame->root frame)
...
(encapsulate
  ...
  (defthm
    partial-collapse-correctness-lemma-179
    (implies
     (and
      (not (zp n))
      (mv-nth
  ...
  (defthm
    partial-collapse-correctness-lemma-182
    (implies
     (and
      (not (zp n))
      (mv-nth
    ...
    ((:bash
     ...
     :up :s :top (:contrapose 16)
     (:dive 2 4)
     := :up
     (:rewrite ctx-app-list-seq-of-append)
     :up
     :s (:bash ("goal" :in-theory (enable frame-addrs-before-seq
                                          ctx-app-list-seq ctx-app-list)
                :use (:instance (:rewrite take-of-nthcdr)
                                (l seq)
                                (n2 (+ -1 n))
  ...
  (defthm
    partial-collapse-correctness-lemma-180
    (implies
     (and
      (abs-separate (frame->frame frame))
      (frame-p (frame->frame frame))
...
(defthmd
  ...
  (("goal" :in-theory (e/d (collapse collapse-seq seq-this collapse-iter)
                           ((:definition assoc-equal)
                            ...
                            (:rewrite partial-collapse-correctness-lemma-24)
                            (:rewrite final-val-of-collapse-this-lemma-6 . 3)
                            (:rewrite final-val-of-collapse-this-lemma-6 . 2)
                            (:definition remove-equal)
                            (:rewrite remove-when-absent)
...
(defthm
  partial-collapse-correctness-lemma-136
  (implies
   (mv-nth 1 (collapse frame))
   (or
    (equal (frame-val->src (cdr (assoc-equal x (frame->frame frame))))
...
(defthm
  ...
  (("goal"
    :in-theory (e/d (seq-this valid-seqp collapse-iter)
                    ((:rewrite partial-collapse-correctness-lemma-136)))
    :use (:instance (:rewrite partial-collapse-correctness-lemma-136)
                    (x x)
                    (frame frame)))))

(defthm
  partial-collapse-correctness-lemma-138
  (implies
   (and
    (consp (frame->frame frame))
    (abs-separate (frame->frame frame))
   ...
   (> (1st-complete (frame->frame (collapse-this frame x)))
      0))
  :hints
  (("goal" :cases ((equal x (1st-complete (frame->frame frame))))
    :in-theory (e/d (valid-seqp collapse-seq seq-this collapse-iter))
    :do-not-induct t
    :expand (collapse-iter (collapse-this frame x)
                           1))
   ("subgoal 1'''" :expand (collapse frame))
   ("subgoal 2''" :expand (collapse-this frame x)))
  :rule-classes :linear)
...
(defthm
  ...
  :hints
  (("goal"
    :in-theory (disable (:rewrite partial-collapse-correctness-lemma-33))
    :use
    (:instance
...
(defthm
  partial-collapse-correctness-lemma-141
  (implies
   (and
    (frame-p (frame->frame frame))
    (mv-nth 1 (collapse frame))
    ...
    (not (equal (1st-complete (frame->frame (collapse-this frame x)))
                (frame-val->src (cdr (assoc-equal x (frame->frame frame)))))))
   (consp (assoc-equal (1st-complete (frame->frame (collapse-this frame x)))
                       (frame->frame frame))))
  :hints (("goal" :do-not-induct t
...
(defthm
  partial-collapse-correctness-lemma-142
  (implies
   (and
    (consp (frame->frame frame))
    (abs-separate (frame->frame frame))
   ...
   (< (len (frame->frame (collapse-iter (collapse-this frame x)
      ...
      (+ -1 (len (frame->frame frame)))))
  :hints
  (("goal" :in-theory (e/d (valid-seqp collapse-seq seq-this collapse-iter))
    :do-not-induct t
    :expand (collapse-iter (collapse-this frame x)
                           1)))
  :rule-classes :linear)
...
(defthm
  partial-collapse-correctness-lemma-143
  (implies
   (and
    (consp (frame->frame frame))
    (abs-separate (frame->frame frame))
    ...
    (no-duplicatesp-equal (strip-cars (frame->frame frame)))
    (<= 1 (+ -1 (len (frame->frame frame)))))
   (consp (seq-this (collapse-this frame x))))
  :hints
  (("goal" :in-theory (e/d (valid-seqp collapse-seq seq-this collapse-iter)
                           ((:rewrite binary-append-take-nthcdr)
                            (:rewrite collapse-seq-of-collapse-seq)))
    :expand (seq-this (collapse-this frame x)))))
...
;; Merge into
;; partial-collapse-correctness-lemma-144 later, fine.
(defthm
  partial-collapse-correctness-lemma-144
  (implies
   (not (member-equal x seq))
   (and
...
(defthm
  partial-collapse-correctness-lemma-145
...
(defthm
  ...
  :hints
  (("goal"
    :in-theory (disable position-when-member)
    :use position-when-member)))
...
;; partial-collapse-correctness-lemma-105 should also be disabled, it shouldn't
;; be running around making a mess of random final-val-seq expressions...
(defthmd
  partial-collapse-correctness-lemma-147
  (implies
   (and (abs-separate (frame->frame frame))
        (frame-p (frame->frame frame))
        (consp (assoc-equal x
  ...
  :hints
  (("goal"
    :in-theory (disable partial-collapse-correctness-lemma-105
                        (:rewrite abs-addrs-of-ctx-app-list-seq))
    :use
    (partial-collapse-correctness-lemma-105
     (:instance
      (:rewrite abs-addrs-of-ctx-app-list-seq)
      (seq seq)
      (l (frame-addrs-before-seq frame x seq))
      (frame frame)
      (relpath (frame-val->path (cdr (assoc-equal x (frame->frame frame)))))
      (fs (frame-val->dir (cdr (assoc-equal x (frame->frame frame))))))))))

(defthm
  partial-collapse-correctness-lemma-148
  (implies
   (and
    (equal (nth (+ -1 n)
                (seq-this (collapse-this frame x)))
    ...
    (assoc-equal
     ...
     (frame->frame
      (collapse-seq (collapse-this frame x)
                    (take (binary-+ -1 n)
                          (seq-this (collapse-this frame x))))))))
  :instructions (:promote (:dive 1 1) := :top :bash))

(defthm
  partial-collapse-correctness-lemma-149
  (implies
   (and
    (abs-separate (frame->frame frame))
    (frame-p (frame->frame frame))
...
(defthm
  partial-collapse-correctness-lemma-150
  (implies
   (equal (nth (+ -1 n)
               (seq-this (collapse-this frame x)))
          (frame-val->src (cdr (assoc-equal x (frame->frame frame)))))
...
(defthm
  ...
  (implies (and (not (member-equal x2 l))
                (mv-nth 1
                        (ctx-app-list-seq fs relpath frame l seq))
                (nat-listp l)
                (nat-listp seq)
...
(defthm
  partial-collapse-correctness-lemma-154
  (implies
   ...
   (iff
    ...
    (ctx-app-ok (frame-val->dir (cdr (assoc-equal x (frame->frame frame))))
                x2 x2-path)))
  :hints (("goal" :in-theory (disable partial-collapse-correctness-lemma-105)
           :use partial-collapse-correctness-lemma-105)))
...
(defthm
  partial-collapse-correctness-lemma-162
  (implies
   (and (<= (nfix n) (len (seq-this frame)))
        (member-equal x (take n (seq-this frame)))
        (no-duplicatesp-equal (strip-cars (frame->frame frame))))
   (not
    (consp (assoc-equal
           x
...
(defthm
  partial-collapse-correctness-lemma-158
  (implies
   (and
    (< (nfix n) (len (seq-this frame)))
...
(defthm
  partial-collapse-correctness-lemma-159
  (implies
   (and (frame-p (frame->frame frame))
        (not (zp (frame-val->src (cdr (assoc-equal (nth n (seq-this frame))
                                                   (frame->frame frame))))))
   ...
   (ctx-app-ok
    ...
    (nthcdr
     ...
     (frame-val->path (cdr (assoc-equal (nth n (seq-this frame))
                                        (frame->frame frame)))))))
  :hints (("goal" :in-theory (e/d (seq-this collapse-iter collapse-seq)
                                  ((:definition member-equal)
                                   (:definition no-duplicatesp-equal)
                                   (:definition remove-equal)
                                   (:definition nthcdr)
...
(defthm
  partial-collapse-correctness-lemma-160
  (implies
   (and (abs-separate (frame->frame frame))
        (frame-p (frame->frame frame))
        (mv-nth 1 (collapse frame))
...
(defthm
  partial-collapse-correctness-lemma-161
  (implies
   (and
    (mv-nth 1 (collapse frame))
    (not (zp x))
...
(defthm
  ...
  (("goal" :in-theory (e/d (valid-seqp collapse-seq seq-this
                                       ...
                                       partial-collapse-correctness-lemma-147
                                       partial-collapse-correctness-lemma-152)
                           ((:rewrite partial-collapse-correctness-lemma-161)
                            collapse-seq-of-collapse-seq
                            ...
                            (:rewrite partial-collapse-correctness-lemma-68)))
    :use (:rewrite partial-collapse-correctness-lemma-161))))

(defthm
  partial-collapse-correctness-lemma-165
  (implies
   (and
    (not (zp n))
    (equal
  ...
  (("goal"
    :in-theory (e/d (valid-seqp collapse-seq seq-this
                                ...
                                partial-collapse-correctness-lemma-147
                                partial-collapse-correctness-lemma-152)
                    ((:rewrite partial-collapse-correctness-lemma-154)
                     collapse-seq-of-collapse-seq
                     take set-difference-equal
                     partial-collapse-correctness-lemma-105
                     (:definition member-equal)
...
(defthm
  ...
  :hints
  (("goal"
    :in-theory (disable (:rewrite partial-collapse-correctness-lemma-158))
    :use (:instance (:rewrite partial-collapse-correctness-lemma-158)
                    (frame (collapse-this frame x))
                    (n (+ -1 n))))))

(defthm
  partial-collapse-correctness-lemma-168
  (implies
   (equal (nth (+ -1 n)
               (seq-this (collapse-this frame x)))
          (frame-val->src (cdr (assoc-equal x (frame->frame frame)))))
...
(defthm
  partial-collapse-correctness-lemma-172
  (implies
   (and
    (not (zp n))
    (equal
...
(encapsulate
  ...
  (defthmd
    partial-collapse-correctness-lemma-173
    (implies
     (and
      (abs-separate (frame->frame frame))
      (frame-p (frame->frame frame))
    ...
    (("goal" :induct (dec-induct n)
      :in-theory (e/d (valid-seqp collapse-seq seq-this)
                      (take (:rewrite binary-append-take-nthcdr)
                            (:rewrite collapse-seq-of-collapse-seq)))))))
