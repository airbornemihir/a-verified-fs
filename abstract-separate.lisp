...
(defthm
  ...
  (("goal"
    :do-not-induct t
    :in-theory (disable (:rewrite partial-collapse-correctness-lemma-51))
    :use (:instance (:rewrite partial-collapse-correctness-lemma-51)
...
(defthm
  partial-collapse-correctness-lemma-134
  (implies
