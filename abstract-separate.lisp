...
(defthm
  ...
  (("goal" :in-theory (e/d (valid-seqp collapse-seq)
                           ((:rewrite partial-collapse-correctness-lemma-95)))
      ...
      (intersectp-equal
       ...
       (names-at
        ...
        (nthcdr
         ...
         (frame-val->path (cdr (assoc-equal x (frame->frame frame)))))))))
    :hints (("goal" :do-not-induct t
             :in-theory (enable ctx-app-list intersectp-equal)))))
  ...
  (defthm
    ...
    (("goal" :in-theory (e/d (ctx-app-list intersectp-equal)
                             ((:rewrite nthcdr-when->=-n-len-l)
                              ...
                              (:rewrite partial-collapse-correctness-lemma-117)
                              (:definition len)
                              (:definition nthcdr)
    ...
    ("goal"
     :in-theory (e/d (frame-addrs-before-seq ctx-app-list ctx-app-list-seq)
                     ((:rewrite ctx-app-list-when-set-equiv)
                      (:definition member-equal)
                      (:rewrite ctx-app-ok-when-absfat-equiv-lemma-4)))))
   (:bash ("goal" :in-theory (enable ctx-app-list ctx-app-list-seq)
...
(encapsulate
  ...
  (thm
   ...
   :hints (("Goal" :in-theory
            (e/d
             (frame-addrs-before-seq ctx-app-list
                                     ctx-app-list-seq)
             ((:rewrite ctx-app-list-when-set-equiv)
              (:definition member-equal)
              (:rewrite
